...
const Navbar = () => {
    ...
    return (
        <>
            <div className={` max-w-screen-2xl bg-white container mx-auto md:px-20 px-4 fixed top-0 right-0 left-0 z-50 dark:bg-slate-900 dark:text-white
            ...
            `}>
                <div className="navbar ">
                    <div className="navbar-start">
                        ...
                        <a className="text-2xl font-bold cursor-pointer">Antique Book</a>
                    </div>
                    <div className="navbar-end space-x-2">
                        ...
                        <label className="swap swap-rotate">
                            ...
                            {/* sun icon */}
                            <svg className="swap-off fill-current w-108 h-8" 
                        ...
                        <div className="">
                            <a className="bg-green-500 text-white p-2 hover:bg-green-800 rounded-md duration-300 cursor-pointer"
